...
**Totals:** 26 MODELLED+SPLICED · 0 MODELLED · 2 CODE-DRAWN · 0 NOT STARTED.
...
| 2 | Remaining detail models | IN PROGRESS | 2 CODE-DRAWN rows left in §1 (silo walls, Solar Post supports); the gutter pair (W-7-TYP, D-8-TYP) landed 25 Sept 2026 as the third splice pattern, eave-hung |
