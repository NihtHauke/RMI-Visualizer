...
- 28 detail rows (the 25 `DETAILS` entries + 2 concrete `byRoof` variants + the Solar Post toggle), keyed to drawing numbers.
  Status as in `docs/TRACKER.md` §1: **19 MODELLED+SPLICED · 0 MODELLED · 9 CODE-DRAWN · 0 NOT STARTED.**
  ...
  - **MODELLED+SPLICED (19):** R-panel side lap F-8-TYP · standing seam F-9-TYP / F-20-TYP · bin vent CS-12-CON (CS-1-TYP note 7) ·
    ...
    gallery supports P-5-C (P-7-C reference).
  - **CODE-DRAWN (9):** HVAC curb on metal CS-13-MP · skylight panels, flush F-12-TYP · vents on metal / SPF Plate D ·
...
1. Remaining detail models — the 9 CODE-DRAWN rows, in the order the buildings need them.
